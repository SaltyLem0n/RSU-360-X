...
{
    [Route("staff/evaluationform/section-1")]
    public sealed class Section1PersonalController : Controller
    {
        private readonly EvDbContext _context;

        public Section1PersonalController(EvDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(Section1PersonalVm vm)
        {
            var id = HttpContext.Session.GetString("UserId");
            if (string.IsNullOrWhiteSpace(id)) return RedirectToAction("Index", "Login");
        ...
        private static readonly string ViewPath = "~/Views/Section1Personal/Index.cshtml";
    }
}
